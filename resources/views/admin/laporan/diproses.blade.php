...
@section('header', 'Laporan Diproses')
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4>Daftar Laporan Diproses</h4>
            </div>

            <div class="card-body p-0">
                @if($laporans->isEmpty())
                <div class="text-center py-4 text-muted">Tidak ada laporan yang sedang diproses.</div>
                @else
                                        ...
                                        <div class="btn-group dropleft d-inline-block ml-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('admin.laporan.status', [$laporan->id_pelaporan, 'masuk']) }}">
                                                    <span class="badge badge-warning">Kembali ke Masuk</span>
                                                </a>
